...
#define WINDOW_WIDTH 1600 //窗口的宽度
#define WINDOW_HEIGHT 900 //窗口的高度

#define FONT_PRECISION 72//字体读取精度
#define FONT_SIZE 18//字体大小比例

#define MIN_VIEW_SCALE 0.5 //窗口的最小缩放
#define MAX_VIEW_SCALE 4 //窗口的最大缩放

#define MAX_VIEW_SPEED_X 10 //窗口的水平方向最大速度
#define MAX_VIEW_SPEED_Y 10 //窗口的竖直方向最大速度
#define MAX_VIEW_SPEED_SCALE 2 //窗口缩放时的最大速度

#define VIEW_ACCELERATE_SPEED_X 100 //窗口水平速度的减速度
...
#define WORLD_HEIGHT 128 //单个的世界的高度
