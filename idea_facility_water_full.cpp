...
idea_facility_water_full* idea_facility_water_full::createNew()
{
    auto f = new idea_facility_water_full();
    return f;
}

void idea_facility_water_full::destroy()
{
    delete this;
}

AnimType idea_facility_water_full::getAnimType()
{
	return AnimType::gridWater_1full;
}

idea_facility_water_full::idea_facility_water_full()
{
	tag = Tag::water;
